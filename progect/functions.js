var main = function() {
	...
	var mat =["ЕЛДА","елда","Елда","МАНДА","Манда","манда","МУДЕ","Муде","муде","х**","х*й","охреневший","ебанутый","охуевший","охуеть","хуй","нахуй","в жопу","нахрен","ебать","*бать","еб*нутый","еба*тый","еба*утый"];
